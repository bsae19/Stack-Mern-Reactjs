...
function Error() {
  ...
  return (
    ...
    <div className="bg-white border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
        ...
        <p className="text-2xl md:text-3xl lg:text-5xl font-bold tracking-wider text-gray-500 mt-4">Page Introuvable</p>
        <p className="text-gray-500 mt-4 pb-4 border-b-2 text-center">Désoler la page est introuvable</p>
